package vttp2022.ssf.day15redis;
...
public class AppConfig {
    ...
    public RedisTemplate<String, String> initRedisTemplate() {
        ...
        //Create an instance of the Jedis Driver (pass the confifguration to the driver)
        JedisClientConfiguration jedisConfig = JedisClientConfiguration.builder().build();
        
        //produces connection - Create a factory of jedis connection
